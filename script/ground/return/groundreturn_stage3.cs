...
public class groundreturn_stage3 : MonoBehaviour
{
    ...
    void OnTriggerStay(Collider other)
    {
        if (other.gameObject.tag == "ground")
        {
            ...
            GameObject pattern1 = other.transform.Find("Stage3_pattern1").gameObject;
            GameObject pattern2 = other.transform.Find("Stage3_pattern2").gameObject;
            GameObject pattern3 = other.transform.Find("Stage3_pattern3").gameObject;
