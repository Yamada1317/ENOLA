...
public class Stage1Objectfactory : MonoBehaviour
{
    [Header("データ")]
    ...
    [Header("ぬいぐるみ生成タイミング")]
    [SerializeField] private int stuffedTiming;
    ...
    void Update()
    {
        if (factorydata.factoryJudge)
        {
            ...
            if(factorydata.plicetalNum == stuffedTiming && first) 
            {
                stuffedCreate();
                first = false;
            }
    ...
    void stuffedCreate()
    {
        //GameObject stuffedobj0 = null;
        GameObject stuffedobj1 = null;
        //GameObject stuffedobj2 = null;
        //stuffedobj0 = Instantiate(Stuffed_obj);
        //stuffedobj0.transform.position = Exit0.transform.position;
        stuffedobj1 = Instantiate(Stuffed_obj);
        stuffedobj1.transform.position = Exit1.transform.position;
        //stuffedobj2 = Instantiate(Stuffed_obj);
        //stuffedobj2.transform.position = Exit2.transform.position;
    }
